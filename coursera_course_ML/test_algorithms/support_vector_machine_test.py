from coursera_course_ML.classification.support_vector_machine import SupportVectorMachine
...
class SupportVectorMachineTest():
    output_path = "./coursera_course_ML/input/support_vector_machine.csv"
